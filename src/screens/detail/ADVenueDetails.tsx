      ...
      <Box className='cursor-pointer'>
        ...
        <ol className='my-5'>
          ...
          <p className='italic indent-5'>
            ...
            , as opposed to the Principe Felipe Museum or Sala Arquerias or even
            the Umbracle.
          </p>
          <br />
          <p className='italic indent-5'>
            Located between two lakes and overlooking the Umbracle and the Turia
            Gardens, and its circular shape in the form of an eye, makes it
            ideal for the reception of all attendees. The entrance to the eye
            will be through the glass walkway, where we will place the red
            carpet and registration area. Inside the Hemisferic, in the
            perimeter ring, we will set up a platform in the north lake, to give
            more space and make it easier for the attendees, especially in case
            we have to take "covid" measures again. For the location of the
            sponsors, we will design the floor in the form of trencadis, so that
            each one has their own well-marked space or can even choose where to
            be located. The sponsors will be interacting with different buffets
            with avant-garde gastronomy and entertainment during the whole
            reception. The Hemisferic has another advantage: the walls of the
            space simulate the eyelid of an eye, so they can be opened or closed
