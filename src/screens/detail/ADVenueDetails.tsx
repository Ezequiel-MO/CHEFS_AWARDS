    ...
    <Paper className='w-[1000px] rounded-xl p-5'>
      ...
      <Box className='mt-5'>
        ...
        <Typography paragraph variant='body2'>
          ...
          shows. This unique builidng has large areas where Events can be held :
          dinners , cocktail parties , presentations , gala dinners , etc. It is
          one of the most emblematic buildings of the complex , and one of the
          spaces more original, due its structure
        </Typography>
