    ...
    <Paper elevation={0} className='p-2 max-w-[900px]'>
      ...
      <div className='grid grid-cols-1'>
        <Typography paragraph variant='h6' align='left' className='indent-3'>
          ...
          TRENCADIS.​ ​ But the individual pieces do not form the work of art,
          they need someone to organise them so that their shapes fit together
          and the glue that binds all the pieces into one. That is CUTT/events:
          the organisation and coordination of the different pieces to obtain an
