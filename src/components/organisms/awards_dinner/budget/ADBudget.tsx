  ...
  return (
    <>
      ...
      <div className='text-center my-2'>
        <Link
          to='/awards_dinner/budget'
          className='hover:underline italic my-2 cursor-pointer font-bold text-med_blue_light'
        >
      ...
      <Box
        ...
        sx={{
          ...
          '& .MuiDataGrid-columnHeaders': {
            backgroundColor: '#8cd4d3',
            color: 'white',
            fontWeight: 'bold',
            fontSize: '1.1rem'
          },
          '& .MuiDataGrid-toolbarContainer, .MuiButton-text': {
            backgroundColor: '#28a7b6 !important',
            padding: '0.5rem 1rem',
            opacity: '0.7'
          },
